...
/**
 * REST controller for managing {@link com.miu.swe.leaseauto.domain.Invoice}.
 */
@RestController
@RequestMapping("/api")
public class InvoiceResource {
    ...
    public ResponseEntity<List<Invoice>> getAllInvoices(
        ...
        if ("booking-is-null".equals(filter)) {
            log.debug("REST request to get all Invoices where booking is null");
            return new ResponseEntity<>(invoiceService.findAllWhereBookingIsNull(), HttpStatus.OK);
        }
