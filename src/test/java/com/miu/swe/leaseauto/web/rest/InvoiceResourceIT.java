...
class InvoiceResourceIT {
    ...
    public static Invoice createEntity(EntityManager em) {
        Invoice invoice = new Invoice().totalAmount(DEFAULT_TOTAL_AMOUNT).paymentStatus(DEFAULT_PAYMENT_STATUS).dueDate(DEFAULT_DUE_DATE);
        return invoice;
    }
    ...
    public static Invoice createUpdatedEntity(EntityManager em) {
        Invoice invoice = new Invoice().totalAmount(UPDATED_TOTAL_AMOUNT).paymentStatus(UPDATED_PAYMENT_STATUS).dueDate(UPDATED_DUE_DATE);
        return invoice;
    }
    ...
    void createInvoice() throws Exception {
        ...
        assertThat(testInvoice.getTotalAmount()).isEqualByComparingTo(DEFAULT_TOTAL_AMOUNT);
    ...
    void putNewInvoice() throws Exception {
        ...
        updatedInvoice.totalAmount(UPDATED_TOTAL_AMOUNT).paymentStatus(UPDATED_PAYMENT_STATUS).dueDate(UPDATED_DUE_DATE);
        ...
        Invoice testInvoice = invoiceList.get(invoiceList.size() - 1);
        assertThat(testInvoice.getTotalAmount()).isEqualByComparingTo(UPDATED_TOTAL_AMOUNT);
    ...
    void partialUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.dueDate(UPDATED_DUE_DATE);
    ...
    void fullUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.totalAmount(UPDATED_TOTAL_AMOUNT).paymentStatus(UPDATED_PAYMENT_STATUS).dueDate(UPDATED_DUE_DATE);
