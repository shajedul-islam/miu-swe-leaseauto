...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_DRIVING_LICENSE_CREDENTIALS = "AAAAAAAAAA";
    private static final String UPDATED_DRIVING_LICENSE_CREDENTIALS = "BBBBBBBBBB";
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .drivingLicenseCredentials(DEFAULT_DRIVING_LICENSE_CREDENTIALS);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .drivingLicenseCredentials(UPDATED_DRIVING_LICENSE_CREDENTIALS);
        return customer;
    }
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getDrivingLicenseCredentials()).isEqualTo(DEFAULT_DRIVING_LICENSE_CREDENTIALS);
    }
    ...
    @Test
    @Transactional
    void checkDrivingLicenseCredentialsIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setDrivingLicenseCredentials(null);
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].drivingLicenseCredentials").value(hasItem(DEFAULT_DRIVING_LICENSE_CREDENTIALS)));
    }
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.drivingLicenseCredentials").value(DEFAULT_DRIVING_LICENSE_CREDENTIALS));
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        assertThat(testCustomer.getDrivingLicenseCredentials()).isEqualTo(UPDATED_DRIVING_LICENSE_CREDENTIALS);
    }
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).drivingLicenseCredentials(UPDATED_DRIVING_LICENSE_CREDENTIALS);
